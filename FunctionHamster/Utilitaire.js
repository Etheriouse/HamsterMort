...
module.exports = {
    ...
    function avatar(message, Discord) {
        ...
        .setTitle(`Avatar de ${authors.username}`)
        .setImage(Img)
        .setColor("RANDOM")
    ...
    function inf(message, Discord) {
        ...
        const embed = new Discord.MessageEmbed()
        .setAuthor(`Commande de ${message.author.username}`)
        .setTitle(`Information de ${authors.username}`) // On crée notre embed
        .addFields(
            {
                name: "Surnom",
